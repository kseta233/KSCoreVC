...
@objc final class KSAlertView : NSObject {
    /**
     ...
     */
    @objc static func alertPopUp(title: String? = nil, message: String? = nil, style: UIAlertController.Style = .alert) -> UIAlertController {
    ...
    @objc static func alertForObjc(title: String? = nil, message: String? = nil) -> UIAlertController {
    ...
    static func alert(title: String? = nil, message: String? = nil, style: KSAlertType = .error) -> Void{
        var color = UIColor()
        switch style {
        case .error:
            color = UIColor(red:174.0/255.0, green:48.00/255.0, blue:51.5/255.0, alpha:1.000)
//            color = UIColor.red
        case .success:
            color = UIColor(red:48.00/255.0, green:174.0/255.0, blue:51.5/255.0, alpha:1.000)
//            color = UIColor.green
        default:
            color = UIColor(red:59.00/255.0, green:153.0/255.0, blue:252.5/255.0, alpha:1.000)
//            color = UIColor.blue
        }
    ...
    @objc static func alertFromTop(title: String? = nil, message: String? = nil, style: KSAlertType = .error) -> Void{
        var color = UIColor()
        switch style {
        case .error:
            color = UIColor(red:174.0/255.0, green:48.00/255.0, blue:51.5/255.0, alpha:1.000)
...
//    static func alertFromApi(response: BaseResponse) -> UIAlertController {
//        let alert = UIAlertController(
//            title: "\(String(describing: response.code))",
...
extension UIAlertController {
    ...
    func willOK(title: String = "OK", handler: ((UIAlertAction) -> ())? = nil) -> UIAlertController {
        return will(title: title, style: .cancel, handler: handler)
    }
...
open class Banner: UIView {
    @objc class func topWindow() -> UIWindow? {
        for window in UIApplication.shared.windows.reversed() {
            if window.isKeyWindow && window.frame != CGRect.zero { return window }
        }
        return nil
    }
    ...
    private func initializeSubviews() {
        ...
        backgroundView.tag = self.viewTag
    ...
    open func show(_ view: UIView? = nil, duration: TimeInterval? = nil) {
        ...
        if view.viewWithTag(self.viewTag) != nil {
            return
        }
