...
extension UIView {
    /// primaryly used to animate show or hide based on their current state into versa state show -> hide, hide -> show. with curve ease animation
    func showHide() {
        if isHidden {
            self.isHidden = false
            self.alpha = 0.0
...
extension UIView {
    ...
    func rounding(corner: UIRectCorner , radius: CGFloat ){
